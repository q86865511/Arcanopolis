...
- **[M4.5-W4 實測，待實玩後定案] 有玩家行為的 30 天曲線暴露四個真實的平衡問題**
  （`npm run balance` 可重跑）：
  1. **石材在第 27 天歸零**且之後一直是 0——採石場的產出跟不上建築消耗，石材是硬瓶頸。
  2. **穀物累積到 9044**：農場離住宅近、磨坊遠，上游效率高於下游，差額逐日放大。
     這是 W1 帶來的佈局效應，但幅度過大，可能要調整食物鏈各段的 jobs 或 workTicks。
  3. **金幣長期卡在 70~93**：稅收（每就業居民每日 2）幾乎剛好被建築成本吃掉，
     金幣是實質上的成長速度閘門。要不要維持這種緊繃是設計決定。
  4. **金屬鏈完全沒被蓋起來**（iron-ore/iron/tools 全程 0）——被石材與金幣雙重卡住，
     玩家在 30 天內根本走不到工具。若這不是預期的節奏，得放寬前段成本。
  這四點都需要你實玩後回報手感才好定值；數字本身現在有護欄鎖住，改壞會當場紅。
